...
namespace RiskyTweaks.Tweaks.Enemies
{
    public class SolusSpawnrates : TweakBase<SolusSpawnrates>
    {
        ...
        protected override void ApplyChanges()
        {
            ...
            SetSpawnCost(Addressables.LoadAssetAsync<CharacterSpawnCard>("RoR2/DLC3/DefectiveUnit/cscDefectiveUnit.asset").WaitForCompletion(), 54);  //Invalidator 40->54, 10 -> 7.4
        }
